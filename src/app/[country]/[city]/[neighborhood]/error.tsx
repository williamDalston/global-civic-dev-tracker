  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-foreground">Unable to load neighborhood data</h1>
        <p className="mt-4 text-muted-foreground">
          There was a problem loading permits for this neighborhood. Please try again.
        </p>
        {error.digest && (
